...
class Macchine extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name;
	var $table_index= 'macchineid';
	...
	var $mandatory_fields = Array('assigned_user_id', 'createdtime', 'modifiedtime', 'codice_seriale'); // crmv@177975
	//crmv@10759
	...
	function __construct() {
		...
		$this->table_name = $table_prefix.'_macchine';
		$this->customFieldTable = Array($table_prefix.'_macchinecf', 'macchineid');
		$this->entity_table = $table_prefix."_crmentity";
		$this->tab_name = Array($table_prefix.'_crmentity', $table_prefix.'_macchine', $table_prefix.'_macchinecf');
		$this->tab_name_index = Array(
			$table_prefix.'_crmentity' => 'crmid',
			$table_prefix.'_macchine'   => 'macchineid',
			$table_prefix.'_macchinecf' => 'macchineid'
		);
		$this->list_fields = Array(
			/* Format: Field Label => Array(tablename, columnname) */
			// tablename should not have prefix 'vte_'
			'Codice seriale'=> Array($table_prefix.'_macchine', 'codice_seriale'),
